...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        <form action="{{ route('plant.store') }}" method="POST"  enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <label class="block">
                    <span class="text-gray-700 font-bold">Ingrese el tipo de planta</span><span class="text-red-600">*</span>
                    <input type="text" name="type" required class="form-input mt-1 block w-full">
                </label>
            </div>
            <div>
                <label class="block">
