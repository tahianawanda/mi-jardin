{{-- resources/views/dashboard/plant/edit.blade.php --}}
        ...
        <form action="{{ route('plant.update', $plant->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <label class="block">
                    ...
                    <input type="text" name="type" value="{{ old('type', $plant->type) }}" required class="form-input mt-1 block w-full">
                </label>
            </div>
            ...
            <div>
                <label class="block">
                    ...
                    <textarea name="description" class="form-textarea mt-1 block w-full">{{ old('description', $plant->description) }}</textarea>
                </label>
            </div>
